const API_ENDPOINTS = {
	...
	OBSERVATORY_DATA:
		"https://api.garfo.ameciclo.org/cyclist-infra/relationsByCity",
	OBSERVATORY_DATA_WAYS: "https://api.garfo.ameciclo.org/cyclist-infra/ways",
	OBSERVATORY_DATA_ALL_WAYS:
		"https://api.garfo.ameciclo.org/cyclist-infra/ways/all-ways",
	OBSERVATORY_DATA_WAYS_SUMMARY:
		"https://api.garfo.ameciclo.org/cyclist-infra/ways/summary",
	CITIES_DATA: "https://api.garfo.ameciclo.org/cities",

	SINISTROS_SUMMARY_DATA:
		"https://api.garfo.ameciclo.org/traffic-crashes/summary",
	SINISTROS_GEOJSON_DATA:
		"https://api.garfo.ameciclo.org/traffic-crashes/geojson",
	SINISTROS_VEHICLES_DATA:
		"https://api.garfo.ameciclo.org/traffic-crashes/vehicles",
	SINISTROS_STREETS_SUMMARY_DATA:
		"https://api.garfo.ameciclo.org/traffic-crashes/streets-summary",

	// DATASUS
	DATASUS_SUMMARY_DATA: "https://api.garfo.ameciclo.org/datasus-deaths/summary",
	DATASUS_CITIES_BY_YEAR_DATA:
		"https://api.garfo.ameciclo.org/datasus-deaths/cities-by-year",
	...
	DATASUS_CAUSAS_SECUNDARIAS_DATA:
		"https://api.garfo.ameciclo.org/datasus-deaths/causas-secundarias",

	// Strapi
	OBSERVATORIO_SINISTROS_PAGE_DATA:
		"https://do.strapi.ameciclo.org/api/plataformas-de-dados?filters[title][$eq]=Observatório de Sinistros Fatais&populate[0]=supportfiles&populate[1]=supportfiles.file&populate[2]=supportfiles.cover&populate[3]=cover&populate[4]=explanationbox",
	PLATAFORMAS_PAGE_DATA:
		"https://do.strapi.ameciclo.org/api/plataformas-de-dados?populate=*",
	...
	VIAS_INSEGURAS_SUMMARY:
		"https://api.garfo.ameciclo.org/samu-calls/streets/summary",
	VIAS_INSEGURAS_TOP:
		"https://api.garfo.ameciclo.org/samu-calls/streets/top?limite=2111&intervalor=1",
	VIAS_INSEGURAS_MAP:
		"https://api.garfo.ameciclo.org/samu-calls/streets/map?limite=2111",
	VIAS_INSEGURAS_HISTORY:
		"https://api.garfo.ameciclo.org/samu-calls/streets/history",
	VIAS_INSEGURAS_SEARCH:
		"https://api.garfo.ameciclo.org/samu-calls/streets/search",
