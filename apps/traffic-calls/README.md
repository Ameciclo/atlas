...
The application will be available at http://localhost:3019
...
docker run -p 3019:3019 --env-file .env atlas-traffic-calls
```
...
**Note:** Database schema is defined in `packages/database/src/schemas/traffic-calls/schema.ts` and shared across the monorepo.
