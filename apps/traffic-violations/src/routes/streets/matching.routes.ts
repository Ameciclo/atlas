...
export const matchLocationRoute = createRoute({
	...
	description:
		"Uses multiple strategies to match a raw location description to official streets.",
	request: {
		body: {
			content: {
				"application/json": {
...
export const batchMatchRoute = createRoute({
	...
	description:
		"Match multiple location descriptions to official streets in one request.",
	request: {
		body: {
			content: {
				"application/json": {
...
export const matchStatsRoute = createRoute({
	...
	description:
		"Get statistics about the current state of the matching pipeline.",
	responses: {
		200: {
			content: {
				"application/json": {
...
export const listValidationsRoute = createRoute({
	...
	description:
		"Get a paginated list of location matches that need human review.",
	request: {
		query: z.object({
...
export const rejectValidationRoute = createRoute({
	...
	description:
		"Human rejects a match suggestion and optionally provides a correct street_code.",
	request: {
		params: z.object({
			id: z.coerce.number().openapi({
				description: "Location street match ID",
