 ...
 */
const API_NAME = "emergency-calls";
	...
	try {
		...
		const openAPIDoc = app.getOpenAPIDocument({
			...
			info: {
				...
				version,
				description: "API for managing emergency calls data",
				contact: {
					name: "Atlas Team",
			...
			servers: [
				...
				},
				{
					url:
						...
						"https://api.ameciclo.org/emergency-calls",
			...
			tags: [
				{
					...
					description: "Operations related to emergency calls",
				},
				{
					name: "System",
