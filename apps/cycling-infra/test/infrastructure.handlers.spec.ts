...
import { listInfrastructure, getInfrastructure } from "../src/routes/infrastructure/infrastructure.handlers.js";
...
const createMockContext = (query: Record<string, string> = {}, params: Record<string, string> = {}) => ({
  req: {
    query: () => query,
