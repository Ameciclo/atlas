	...
	try {
		...
		const openAPIDoc = app.getOpenAPIDocument({
			...
			info: {
				...
				version,
				description:
					"API service for managing traffic deaths data from DATASUS (Brazil's public health data system)",
				contact: {
					name: "Atlas Team",
			...
			servers: [
				...
				},
				{
					url:
						...
						"https://api.ameciclo.org/traffic-deaths",
			...
			tags: [
				{
					name: "Summary",
					description: "Traffic deaths summary statistics",
				},
				{
					name: "Cyclists",
					description: "Cyclist-specific traffic deaths (CID-10 codes V10-V19)",
				},
				{
					name: "System",
