...
API service for traffic_deaths
...
pnpm --filter @atlas/traffic-deaths db:generate

# Apply migrations
pnpm --filter @atlas/traffic-deaths db:migrate

# View database with Drizzle Studio
pnpm --filter @atlas/traffic-deaths db:studio

# Seed the database with sample data
pnpm --filter @atlas/traffic-deaths db:seed
```
