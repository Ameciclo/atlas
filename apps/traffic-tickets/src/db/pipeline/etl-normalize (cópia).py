#!/usr/bin/env python3
"""
ETL v3: Normalize 19 raw files -> traffic-tickets-compiled.tsv (7 columns).
...
INFRA_DIR = os.path.join(PARENT, "source-data")
DICT_LOCAIS = os.path.join(PARENT, "data", "location-descriptions.json")
OUT_TSV = os.path.join(PARENT, "data", "traffic-tickets-compiled.tsv")
...
def load_location_dict():
    """Load location-descriptions.json -> mapping raw_string to location_id."""
