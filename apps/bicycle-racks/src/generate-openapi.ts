...
async function generateOpenAPISpec() {
	try {
		...
		const openAPIDoc = app.getOpenAPIDocument({
			openapi: "3.1.0",
			info: {
				title: "Bicycle Racks API",
				version,
				description: "API for managing bicycle parking facilities",
				contact: {
					name: "Atlas Team",
			...
			servers: [
				...
				},
				{
					url:
						...
						"https://api.ameciclo.org/bicycle-racks",
			...
			tags: [
				{
					name: "Bicycle Racks",
					description: "Operations related to bicycle parking facilities",
				},
				{
					name: "System",
