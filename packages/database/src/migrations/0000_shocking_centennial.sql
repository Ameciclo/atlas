...
--> statement-breakpoint
CREATE TABLE "traffic_tickets_catalog" (
	"id" serial PRIMARY KEY NOT NULL,
	"law_code" text NOT NULL,
	"canonical_description" text NOT NULL,
	"known_variants" text[] DEFAULT '{}' NOT NULL,
	"category" text NOT NULL,
	"differentiation" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "traffic_tickets_locations" (
	"id" serial PRIMARY KEY NOT NULL,
	"location_id" integer NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "traffic_tickets_locations_location_id_unique" UNIQUE("location_id")
);
--> statement-breakpoint
...
ALTER TABLE "pdc_relation_ways" ADD CONSTRAINT "pdc_relation_ways_relation_id_cyclist_infra_relations_id_fk" FOREIGN KEY ("relation_id") REFERENCES "public"."cyclist_infra_relations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "traffic_tickets" ADD CONSTRAINT "traffic_tickets_violation_id_traffic_tickets_catalog_id_fk" FOREIGN KEY ("violation_id") REFERENCES "public"."traffic_tickets_catalog"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "traffic_tickets_locations" ADD CONSTRAINT "traffic_tickets_locations_street_code_official_streets_code_fk" FOREIGN KEY ("street_code") REFERENCES "public"."official_streets"("code") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_year_munocor" ON "traffic_deaths" USING btree ("data_year","codmunocor");--> statement-breakpoint
CREATE INDEX "idx_ttc_category" ON "traffic_tickets_catalog" USING btree ("category");--> statement-breakpoint
CREATE INDEX "idx_ttc_variants" ON "traffic_tickets_catalog" USING btree ("known_variants");--> statement-breakpoint
CREATE INDEX "idx_ttl_location_id" ON "traffic_tickets_locations" USING btree ("location_id");--> statement-breakpoint
CREATE INDEX "idx_ttl_is_new" ON "traffic_tickets_locations" USING btree ("is_new");--> statement-breakpoint
CREATE INDEX "idx_ttl_semaphore" ON "traffic_tickets_locations" USING btree ("semaphore_number");--> statement-breakpoint
CREATE INDEX "idx_ttl_street_code" ON "traffic_tickets_locations" USING btree ("street_code");